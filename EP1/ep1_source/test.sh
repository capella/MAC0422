...
do
    ...
    ./capta 10 < t-4-1.txt >> t4-1a.txt
    ./ep1 2 t-1.txt t4-2.txt
    ./capta 10 < t-4-2.txt >> t4-2a.txt
    ./ep1 3 t-1.txt t4-3.txt
    ./capta 10 < t-4-3.txt >> t4-3a.txt  
done
...
do
    ...
    ./capta 100 < t-5-1.txt >> t5-1a.txt
    ./ep1 2 t-2.txt t5-2.txt
    ./capta 100 < t-5-2.txt >> t5-2a.txt
    ./ep1 3 t-2.txt t5-3.txt
    ./capta 100 < t-5-3.txt >> t5-3a.txt  
done
...
do
    ...
    ./capta 1000 < t-6-1.txt >> t6-1a.txt
    ./ep1 2 t-3.txt t6-2.txt
    ./capta 1000 < t-6-2.txt >> t6-2a.txt
    ./ep1 3 t-3.txt t6-3.txt
    ./capta 1000 < t-6-3.txt >> t6-3a.txt  
done
